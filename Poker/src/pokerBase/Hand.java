...
public class Hand {
	...
	public Hand(Deck deck) {
		...
		for (int x = 0; x < 5; x++) {
			...
			// Can't get this portion of the code to work yet...trying to create an array list of every possible hand with Wilds
		if (WildCards != null) {
	...
	public void setWildHands(ArrayList<Hand> arrList) {
		WildHands = arrList;
	}
